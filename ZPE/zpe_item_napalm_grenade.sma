...
public plugin_init()
{
	...
	g_Item_ID = zpe_items_register(ITEM_NAPALM_NAME, ITEM_NAPALM_COST);
}
...
public plugin_precache()
{
	...
	Precache_Sounds(g_aSound_Napalm_Buy_Item);
}
...
public zpe_fw_items_select_post(iPlayer, iItem_ID)
{
	...
	ArrayGetString(g_aSound_Napalm_Buy_Item, RANDOM(ArraySize(g_aSound_Napalm_Buy_Item)), szSound, charsmax(szSound));
